...
old_cite = ("Awoyemi, A. (2026). LUMA WNBA Stint Corpus (Version 1.0.0) [Data set].\n"
            "https://github.com/lumahoops/WNBA")
if old_cite in r:
    r = r.replace(old_cite,
                  "Awoyemi, A. (2026). LUMA WNBA Stint Corpus (Version 1.0.0) [Data set].\n"
...
if "zenodo.org/badge" not in r:
    r = r.replace("# LUMA WNBA Stint Corpus\n", "# LUMA WNBA Stint Corpus\n\n%s\n" % badge, 1)
open(p, "w", encoding="utf-8", newline="\n").write(r)
